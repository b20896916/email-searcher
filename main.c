...
void token_hash (char content[100000], lld hash_array[100000], int *len); // hash content to hash_array, save token_num to len
int name_hash(char name[32]); // not implemented
